...
export const csDictionary: Dictionary = {
    ...
    contactPanel: {
        quickChannelsLabel: "Rychlé kanály",
        responseTimeLabel: "Čas odpovědi",
        responseTimeValue: "Obvykle do 24 hodin",
        emailTitle: "E-mail",
        emailSubtitle: "Přímá cesta do schránky pro poptávky.",
        linkedinTitle: "LinkedIn",
        linkedinSubtitle: "Profesionální profil, síť kontaktů a příležitosti.",
        githubTitle: "GitHub",
        githubSubtitle: "Ukázky kódu, experimenty a repozitáře.",
        openChannel: "Otevřít kanál",
        unavailable: "Nedostupné",
        copyEmail: "Kopírovat e-mail",
        copied: "Zkopírováno",
        formLabel: "Přenosový formulář",
        directToLabel: "Přímo na",
    },
    footer: {
